const events = [
  {
    ...
    access: "Free",
    description: "The leading event for architects and designers to source innovative surface materials.",
    link: "https://www.surfacedesignshow.com/"
  },
  {
    title: "Cyber Security & Cloud Expo Global",
    start: "2026-02-04",
    end: "2026-02-05",
    sector: "Cyber Security",
    location: "Olympia London",
    access: "Free",
    description: "Key event exploring zero-trust, threat detection, and cloud infrastructure.",
  ...
  },
  {
    ...
    access: "Paid",
    description: "The premier international forum for the defence and security geospatial community.",
  ...
  {
    title: "IFGS 2026 (UK FinTech Week)",
    start: "2026-04-21",
    end: "2026-04-21",
    sector: "Fintech",
  ...
  {
    title: "Solar & Storage Live London",
    start: "2026-04-29",
    end: "2026-04-30",
    sector: "Renewables",
    location: "ExCeL London",
